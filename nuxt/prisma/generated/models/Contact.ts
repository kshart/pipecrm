...
export type ContactWhereInput = {
  ...
  telegram?: Prisma.StringNullableFilter<"Contact"> | string | null
  viber?: Prisma.StringNullableFilter<"Contact"> | string | null
...
export type ContactScalarWhereWithAggregatesInput = {
  ...
  telegram?: Prisma.StringNullableWithAggregatesFilter<"Contact"> | string | null
  viber?: Prisma.StringNullableWithAggregatesFilter<"Contact"> | string | null
...
export type ContactOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"uuid" | "title" | "phone" | "telegram" | "viber" | "whatsapp" | "email" | "userId", ExtArgs["result"]["contact"]>
...
export interface ContactDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const contactWithUuidOnly = await prisma.contact.findMany({ select: { uuid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Contacts and only return the `uuid`
   * const contactWithUuidOnly = await prisma.contact.createManyAndReturn({
   *   select: { uuid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Contacts and only return the `uuid`
   * const contactWithUuidOnly = await prisma.contact.updateManyAndReturn({
   *   select: { uuid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ContactFieldRefs {
  ...
  readonly telegram: Prisma.FieldRef<"Contact", 'String'>
  readonly viber: Prisma.FieldRef<"Contact", 'String'>
